...
pic = 16
I = cv2.imread('../orthoimage/Project/TCR-SB-240310/images/tcr_SB_252.jpg')
...
cameraInfo = Info({
    "focalLengthX": 1317, # 1200.6831,         # focal length x
    "focalLengthY": 1317, # 1200.6831,         # focal length y
    "opticalCenterX": int(width / 2), # 638.1608,        # optical center x
    "opticalCenterY": int(height / 2), # 738.8648,       # optical center y
    "cameraHeight": 1200, # 1879.8,  # camera height in `mm`
    "pitch": 25.2,           # rotation degree around x
    "yaw": 0,              # rotation degree around y
    "roll": 0              # rotation degree around z
})
ipmInfo = Info({
...
print("finished");
# save image
cv2.imwrite('processed/tcr_sb_252_pp_5.png',outImage)
